        ...
        <div className="flex flex-col lg:flex-row gap-6 lg:gap-8">
          <div className="flex-1 lg:max-w-md">
            ...
            <div className="grid grid-cols-3 gap-3">
              {THEMES.map((t) => (
                ...
                >
                  <div
                    className="relative h-10 w-full rounded-md overflow-hidden border border-base-content/10"
                    data-theme={t}
                  >
          ...
          <div className="flex-1">
            ...
            <div
              ...
              className="rounded-xl border border-base-300/50 overflow-hidden bg-base-100 shadow-inner"
            >
